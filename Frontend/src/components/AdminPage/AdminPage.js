            ...
            <div className="m-5">
                ...
                <div style={{ marginTop: '80px' }}>
                    <div className='row' style={{ width: '60%' }}>
                        ...
                        <div className="col" style={{ maxWidth: 'fit-content' }}>
                            <p className='btn border' title='Refresh' style={{ paddingTop: '5px' }} onClick={() => { refreshOrdersClick() }}><i className="fa-solid fa-rotate fs-5"></i></p>
                        </div>
                    </div>
                ...
                <div style={{ marginTop: '80px' }}>
                    <div className='row' style={{ width: '60%' }}>
                        ...
                        <div className="col" style={{ maxWidth: 'fit-content' }}>
                            <p className='btn border' title='Refresh' style={{ paddingTop: '5px' }}><i className="fa-solid fa-rotate fs-5"></i></p>
                        </div>
                    </div>
                    <div className='mt-3' style={{ width: '100%', height: '330px', overflowY: 'auto', position: 'sticky', top: 0 }}>
                        <table className="table" style={{ borderCollapse: 'collapse' }}>
