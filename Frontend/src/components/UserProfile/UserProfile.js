...
function UserProfile() {
  ...
  async function cancelOrderClick(product) {
    await axios.delete(`https://pujari-jcb-spares-order.onrender.com/cancleOrder/${product._id}`)
      .then((response) => {
        async function getAllOrders() {
          await axios.get(`https://pujari-jcb-spares-order.onrender.com/getOrders/${userInfo.email}`)
            .then((response) => {
              setAllOrders(response.data)
